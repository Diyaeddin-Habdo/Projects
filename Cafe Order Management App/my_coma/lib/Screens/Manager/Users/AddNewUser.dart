...
class _AddUserPageState extends State<AddUserPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(S.of(context).scnDUA,style: TextStyle(color: Colors.white),),
          ...
          child: Column(
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: ['Waiter', 'Chef', 'Cashier'].map((role) {
                  return DropdownMenuItem(
                    value: role,
                    child: Text(locale == 'en' ? role : (role == 'Waiter' ? 'Garson' : (role == 'Chef' ? 'Şef' : 'Kasiyer'))),
                  );
                }).toList(),
                onChanged: (value) {
                  setState(() {
              ...
              ElevatedButton(
                ...
                child: Text(S.of(context).scnDUA,style: TextStyle(color: Colors.white),),
              ),
            ],
          ),
        ),
