...
class _TablesPageState extends State<TablesPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(S.of(context).scnDT,style: TextStyle(color: Colors.white),),
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text('${S.of(context).scnDPPS}: ${table['status']}',style: TextStyle(color: table['status'] == 'Dolu' ? Colors.red:Colors.green),),
                    trailing: Row(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.of(context).push(MaterialPageRoute(builder: (context) => AddNewTablePage())).then((_){_fetchTables();});
        },
        backgroundColor: Colors.indigo.shade900,
