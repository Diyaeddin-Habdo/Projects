...
class _UpdateProductPageState extends State<UpdateProductPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(S.of(context).scnDPU,style: TextStyle(color: Colors.white),),
          ...
          child: Column(
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: ['Var', 'Yok'].map((status) {
                  return DropdownMenuItem(
                    value: status,
                    child: Text(locale == 'tr' ? status : (status == 'Var' ? 'Available' : 'Unavailable')),
                  );
                }).toList(),
                onChanged: (value) {
                  setState(() {
              ...
              ElevatedButton(
                ...
                child: Text(S.of(context).scnDPU,style: TextStyle(color: Colors.white),),
              ),
            ],
          ),
        ),
