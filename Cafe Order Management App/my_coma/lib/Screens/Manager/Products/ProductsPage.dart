...
class _ProductsPageState extends State<ProductsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(S.of(context).scnDP,style: TextStyle(color: Colors.white),),
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text('${S.of(context).scnDPP}: ${product.price} ₺ | ${S.of(context).scnDPPS}: ${locale == 'en'? (product.status == 'Var' ? 'Available':'Unavailable') : product.status}',style:TextStyle(color: product.status == 'Yok' ? Colors.red:Colors.green),),
                    trailing: Row(
